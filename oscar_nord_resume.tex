...
\section{Projects Source available on GitHub}
  \resumeSubHeadingListStart
    \resumeSubItem{\textmu{}TUI \textit{(C++)} }
      { \\
      \indent-- Bachelor project for Visualization Center C in Norrkšping, Sweden. \\
      \indent-- It is a TUI (Tangible User Interface) application for navigating information on a large touch screen with physical cards.\\
    ...
    \resumeSubItem{Fluids \textit{(C++)} }
       {\\ 
       \indent-- Fluid simulation using the \textit{Navier-Stokes}-equations done in the course TNM085 (Modeling project) at Linkšpings University} 
      
    \resumeSubItem{Audiovis \textit{(JavaScript)} }
      {\\
      \indent-- Audio visualiser built with Web Audio API and Three.js done in the course TFYA65 (Physics of Sound) at Linkšpings University}
...
\section{Leadership Experience}
  \resumeSubHeadingListStart
    \resumeSubItem{Programming mentor, LiTHehack 17/18}
      {\\
      \indent-- LiTHehack is a student-driven project at Linkšping University aiming to help and inspire students with programming. \\
