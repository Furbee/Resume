...
\section{Projects Source available on GitHub}
  \resumeSubHeadingListStart
    ...
    \resumeSubItem{Starfruit, Spotify devX \textit{(JavaScript)} }
       {\\ 
       \indent-- Website that matches music taste to different characters. \\  
       \indent-- Built using Spotify WebAPI and Node.js.}
